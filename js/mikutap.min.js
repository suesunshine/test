...
Explore
 ...
 Watch 1
  Star 0
  Fork 0 suesunshine/test
 Code  Issues 0  Pull requests 0  Projects 0  Wiki  Insights
Branch: master Find file Copy pathtest/js/mikutap.min.js
d416290  4 hours ago
@suesunshine suesunshine Signed-off-by: wss12740 <wss12740@ly.com>
1 contributor
RawBlameHistory     
1708 lines (1704 sloc)  56.6 KB
$(function() {
...
var MainManager = function() {
    ...
    $(".start").click(function(a) {
        var lianai = $(this).html()
        for(var key in count){
            count[key] = 0;
        };
        (new Image()).src = "http://wx3.sinaimg.cn/mw690/675f3c9cgy1fnma8o5ek6j20kz10u419.jpg"
        $("#startgame").fadeOut(400, "linear"),
        $("#scene_top").stop().fadeOut(200, "linear"),
        $("#scene_loading").stop().fadeIn(200, "linear"),
        2 == C ? t() : ((new aidn.WebAudio).load(""),
        P.init(n, e))
        setTimeout(function(){
            var str = "统计结果调试输出：</br></br>恋爱状态："+lianai+"</br></br>"
            for(var key in count){
                str += key+count[key]+"次，</br>"
            }
            str += "</br>实际应以统计结果弹出相应关键词"
            $("#endgame").fadeIn(400, "linear")
            $("#endgame").html(str)
            g = 0,
            k.end(),
            P.end(),
    ...
    , k = new function() {
        ...
        function l() {
            var a = Math.random();
            return .03 > a ? 0000000 : .18 > a ? 16777215 : R[s()]
        }
        function s() {
            for (var a = 0; 10 > a; a++) {
        ...
        var u, v = -1, y = 4, I = 8, x = !1, C = !1, g = [], P = [function(a, e) {
            ...
            var t = function(a) {
                ...
                ;
                var n = new PIXI.Sprite.fromImage('./test/爱心.png');;
                a.addChild(n)
            };
            this.play = function() {
            console.log("空心点炸裂开始")
        ...
        , function(a, e) {
            ...
            var t = function(a) {
                ...
                ;
                var n = new PIXI.Sprite.fromImage('./test/电影.png');
                a.addChild(n)
            };
            this.play = function() {
            console.log("方块散花开始")
        ...
        , function(a, e) {
            ...
            var t = function(a) {
                ...
                ;
                var i, o, r, l = new PIXI.Sprite.fromImage('./test/玫瑰花.png');
                l.scale.x = 0;
                l.scale.y = 0;
                a.addChild(l)
            };
        ...
        , function(a, e) {
            ...
            var t = function(a) {
                ...
                ;
                var i, o, r = new PIXI.Sprite.fromImage('./test/吻.png');
        ...
        , function(a, e) {
            ...
            var t = function(a) {
                ...
                ;
                var i, o, r = new PIXI.Sprite.fromImage('./test/酒杯.png');
                r.width=0;r.height=0;
                a.addChild(r)
            };
            this.play = function() {
        ...
        , function(a, e) {
            ...
            var t = function(a) {
                ...
                ;
                var t, i = new PIXI.Sprite.fromImage('./test/裙子.png');
                a.addChild(i);
                var o, l
            };
            this.play = function() {
        ...
        , function(a, e) {
            ...
            var t = function(a) {
                ...
                ;
                var t, i = new PIXI.Sprite.fromImage('./test/巧克力.png');;
                a.addChild(i);
                var o, r
            };
            this.play = function() {
        ...
        for (var X, F = 16 * Math.random(), G = [], B = 0; B < P.length + k.length; B++)
            G[B] = [];
        var z, E = [13430510, 16709878, 9099756, 961181, 1089457, 34969, 13934238, 16110792, 15488645, 16531063, 5853015, 3222317], R = [13430510, 16709878, 9099756, 961181, 1089457, 34969, 13934238, 16110792, 15488645, 16531063, 5853015, 3222317], S = E.length, A = 0, D = 0
    }
